import {
  ...
  export const GET = async (req: Request) => {
    const payload: ActionGetResponse = {
      ...
      description: "Submit your Superteam profile for $SEND giveaway",
      label: "Submit Profile",
      links: {
        actions: [
          {
            label: "Submit Profile",
            href: `${new URL(req.url).origin}/api/actions/giveaway?profileLink={profileLink}`,
            parameters: [
              {
                name: "profileLink",
                label: "Link of your Superteam Earn profile",
                required: true,
              },
            ],
          },
